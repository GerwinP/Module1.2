...
public class PasswordTest {
    ...
    public void testAcceptable() {
        ...
        assertEquals("pass.acceptable(\"no\")", 
                     false, pass.acceptable("no"));
        assertEquals("pass.acceptable(\"no no\")", 
                     false, pass.acceptable("no no"));
        assertEquals("pass.acceptable(\"yesyesyes\")", 
                     true, pass.acceptable("yesyesyes"));
    }
    ...
    public void testTestWord() {
        ...
        assertEquals("pass.testWord(\"wrong\")", 
                     false, pass.testWord("wrong"));
        assertEquals("pass.testWord(Password.INITIAL)", 
                     true,  pass.testWord(Password.INITIAL));
    ...
    public void testSetWordWrongOld() {
        ...
        assertEquals("pass.testWord(Password.INITIAL)", 
                     true,  pass.testWord(Password.INITIAL));
        assertEquals("pass.testWord(\"" + newpass + "\")", 
                     false, pass.testWord(newpass));
    }
    ...
    public void testSetWordOkay() {
        ...
        assertEquals("pass.testWord(Password.INITIAL)", 
                     false, pass.testWord(Password.INITIAL));
        assertEquals("pass.testWord(\"" + newpass + "\")", 
                     true, pass.testWord(newpass));
    }
